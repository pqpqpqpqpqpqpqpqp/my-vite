                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                            ...
                            <button className="px-5 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                                동행 모집하기
                            </button>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                            <div className="bg-pink-100 text-pink-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
                            ...
                            <button className="px-5 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors">
                                명소 찾아보기
                            </button>
                        </div>
                    </div>
            ...
            <section className="bg-blue-600 text-white">
                <div className="container mx-auto px-6 py-20 text-center flex flex-col items-center">
                    ...
                    <p className="text-lg max-w-xl mb-8">{serviceName}과 함께라면 여행 준비도 쉽고 빠릅니다. 지금 바로 당신만의 특별한 여정을 만들어보세요.</p>
                     <Link to="/trip/plan/select">
                        <button className="px-8 py-4 bg-white text-blue-600 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-transform transform hover:scale-105 shadow-lg">
                            지금 바로 시작하기
                        </button>
                    </Link>
                </div>
