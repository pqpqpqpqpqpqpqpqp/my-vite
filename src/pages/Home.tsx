...
export default function Home() {
    return (
        <main className="overflow-x-hidden">
            <section className="flex flex-col justify-center items-center text-center min-h-screen bg-blue-50 rounded-xl">
            ...
            <section className="flex flex-col justify-center items-center text-center min-h-screen py-12 bg-green-50 rounded-xl">
            ...
            <section className="flex flex-col justify-center items-center text-center min-h-screen py-12 bg-pink-50 rounded-xl">
            ...
            <section className="flex flex-col justify-center items-center text-center min-h-screen py-12 bg-gray-100 rounded-xl">
